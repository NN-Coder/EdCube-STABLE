...
File: .env.local
```
NEXT_PUBLIC_SUPABASE_URL=https://hftvwwtqznujktobbxol.supabase.co
NEXT_PUBLIC_SUPABASE_PUBLISHABLE_DEFAULT_KEY=sb_publishable_OVXY6hNIwueyU7CG0dMlMw_KZgWX1ug
```
